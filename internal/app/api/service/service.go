...
func (s *Service) GetTime(ctx context.Context, site string) (*domain.Answer, error) {
	resp, err := s.repo.GetTime(ctx, site)
	if err != nil {
...
func (s *Service) GetMinTime(ctx context.Context) (*domain.Site, error) {
	resp, err := s.repo.GetMinTime(ctx)
	if err != nil {
...
func (s *Service) GetMaxTime(ctx context.Context) (*domain.Site, error) {
	resp, err := s.repo.GetMaxTime(ctx)
	if err != nil {
